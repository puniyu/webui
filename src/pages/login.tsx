...
const Login = () => {
  ...
  return (
    <Box className="w-full min-h-dvh py-8 flex justify-center items-center bg-linear-to-br from-pink-50 via-rose-50 to-fuchsia-100 dark:from-gray-900 dark:via-black dark:to-gray-900 relative">
